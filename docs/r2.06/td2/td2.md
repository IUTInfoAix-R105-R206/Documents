---
title: "TD2 : Jointures externes, partitionnement et synthèse des requêtes"
...
| `categorie` | Catégorie d'un client | `D_CATEGORIE : VARCHAR2(15)` | {BON, PRIVILEGIE} |
...
Le MCD (voir `figure~\ref{fig:mcd}`{=latex}) modélise quatre entités : 
